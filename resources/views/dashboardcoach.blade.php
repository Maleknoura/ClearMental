                        ...
                        <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-8">
                          <div class="">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                              <thead class="bg-[#4a044e] text-white">
                                <tr>
                                  <th class="p-3 font-medium tracking-wider uppercase">Client</th>
                                  <th class="p-3 font-medium tracking-wider uppercase">Status</th>
                                  <th class="p-3 font-medium tracking-wider uppercase">Created At</th>
                                </tr>
                              </thead>
                              <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                  ...
                                  <td class="p-3">
                                    <span
                                      ...
                                      x-text="statusText"
                                      @click="toggleStatus()"
                                      :class="statusText === 'En attente' ? 'text-yellow-500' : 'text-green-500'"
                                      class="status-text cursor-pointer"
                                    ></span>
                                  </td>
                                  <td class="p-3">2023-04-26 10:30:00</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                    ...
                    <script>
                      function toggleStatus() {
                        return {
                          ...
                          toggleStatus() {
                            this.statusText = this.statusText === 'En attente' ? 'Confirmed' : 'En attente';
                          }
                        }
                      }
                    </script>
