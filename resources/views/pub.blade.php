...
<div x-data="setup()" x-init="$refs.loading.classList.add('hidden');">
    ...
    <div class="text-center">
        <h2 class="text-3xl font-extrabold text-[#333] inline-block">Publications</h2>
    </div>
        ...
        <table class="w-full border-collapse border border-orange-500 max-w-xl mt-16 mx-auto">
            ...
            <thead>
                <tr class="bg-orange-500 text-white">
                    ...
                    <th class="py-4 px-16 text-left">Contenu</th>
            ...
            <tbody>
                @foreach ($publications as $publication)
                    <tr class="bg-white border-b border-orange-500">
                        <td class="py-2 px-8"> <img src="{{ asset('storage/images/' . $publication->image) }}"
                                alt="" width="120px" height="90px">
                        </td>
                        <td class="py-2 px-16">  {{ $publication->Contenu }}
                        </td>
                        <td class="py-2 px-8">  {{ $publication->title }}
                        </td>
                        <td class="py-2 px-8">   <button data-modal-target="update-modal" data-modal-toggle="update-modal" data-tag-id="" class="block text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                            Update
                        </button>
                    </td>
                    ...
                    <form method="post" action="{{ route('publication.update', $publication->id) }}" class="p-4 md:p-5" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div>
                                ...
                                <select name="tags[]" id="tags" class="bg-gray-50 w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    @foreach($tags as $tag)
                        ...
                        <div>
                            <label for="image" class="block w-full mb-2 text-sm font-medium text-gray-900 dark:text-white">Image</label>
  ...
  <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative p-4 w-full max-w-md max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <!-- Modal body -->
              <form class="p-4 md:p-5"method="post" action="{{ route('publication.store') }}" enctype="multipart/form-data">
                @csrf
                  <div class="grid gap-4 mb-4 grid-cols-2">
                      <div class="col-span-2">
                      ...
                      <div class="col-span-2 sm:col-span-1">
                          ...
                          <input type="text" name="Contenu" id="contenu" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="">
                      </div>
                      <div class="col-span-2 sm:col-span-1">
                          <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tag</label>
                          <select name="tags[]" id="tags"   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            @foreach($tags as $tag)
                            <option value="{{ $tag->id }}">{{ $tag->name }}</option>
                        @endforeach
                          </select>
                  ...
                  <button type="submit" class="text-white inline-flex items-center bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
